...
import math
import numpy as np
from alphasystem import AlphaSystem
...
class BOT_SIMULATOR:
    ...
    def loop(self, bodies, model, main=None, plot=None, rocket=None, plot_actions=None):
        """([Body])
        ...
        while True:
            ...
            if self.DRIVE == True:
                system = AlphaSystem()
                pred = system.get_action(bodies[rocket].px, bodies[rocket].py, bodies[rocket].vx, bodies[rocket].vy, self.angle, self.START)
